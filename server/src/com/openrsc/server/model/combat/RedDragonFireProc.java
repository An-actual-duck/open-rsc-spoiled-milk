...
/** Shared execution policy for the current Red Dragon fire proc. */
public final class RedDragonFireProc {
	private static final double PROC_CHANCE = 0.20D;
	private static final int MAX_PROC_DAMAGE = 10;
	private static final int DEFENSE_DEBUFF_PERCENT = 6;

	private RedDragonFireProc() {
	}
	 ...
	 *
	 * @return whether the fire proc activated, including a zero damage roll
	 */
