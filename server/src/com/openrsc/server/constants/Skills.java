...
public class Skills {
	...
	public static final String NONE = "NONE", MELEE = "MELEE", ATTACK = "ATTACK", DEFENSE = "DEFENSE", STRENGTH = "STRENGTH", HITS = "HITS", RANGED = "RANGED",
		...
		*/
		...
		if (constants.getServer().getConfig().INFLUENCE_INSTEAD_QP) {
			...
			if(constants.getServer().getConfig().WANT_RUNECRAFT) {
				skills.add(new SkillDef("Enchanting", "Enchanting", 1, 99, SkillDef.EXP_CURVE.ORIGINAL, skillIndex++));
			}
