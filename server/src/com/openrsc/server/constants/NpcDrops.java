...
public class NpcDrops {
	...
	public Item getSlayerBaselineDrop(int npcId) {
		return config.WANT_MYWORLD
			? slayerComponents.baseline(npcId, world.getServer().getCombatRandom()) : null;
	}
	...
	private void generateNpcDrops() {
		...
		if(config.WANT_OPENPK_POINTS) {
			...
			currentNpcDrops.addItemDrop(ItemId.COINS.id(), 250, 17);
		} else {
			currentNpcDrops.addItemDrop(ItemId.COINS.id(), 250, 27);
		}
		currentNpcDrops.addTableDrop(herbDropTable, 10);
		currentNpcDrops.addTableDrop(rareDropTable, 5);
		currentNpcDrops.addItemDrop(ItemId.COINS.id(), 500, 18);
		currentNpcDrops.addItemDrop(ItemId.COINS.id(), 1000, 8);
		currentNpcDrops.addItemDrop(ItemId.COINS.id(), 2500, 1);
		currentNpcDrops.addItemDrop(ItemId.EARTH_RUNE.id(), 250, 10);
		currentNpcDrops.addItemDrop(ItemId.EARTH_RUNE.id(), 500, 4);
		currentNpcDrops.addItemDrop(ItemId.CHAOS_RUNE.id(), 40, 9);
		currentNpcDrops.addItemDrop(ItemId.CHAOS_RUNE.id(), 100, 3);
		currentNpcDrops.addItemDrop(ItemId.DEATH_RUNE.id(), 15, 6);
		currentNpcDrops.addItemDrop(ItemId.DEATH_RUNE.id(), 40, 2);
		currentNpcDrops.addItemDrop(ItemId.BLOOD_RUNE.id(), 10, 4);
		currentNpcDrops.addItemDrop(ItemId.NATURE_RUNE.id(), 25, 4);
		currentNpcDrops.addItemDrop(ItemId.LAW_RUNE.id(), config.WANT_OPENPK_POINTS ? 20 : 5, 3);
		currentNpcDrops.addItemDrop(ItemId.RUNE_PLATE_MAIL_LEGS.id(), 1, 1);
		currentNpcDrops.addItemDrop(ItemId.LARGE_RUNE_HELMET.id(), 1, 1);
		currentNpcDrops.addItemDrop(ItemId.TITAN_STEEL_PLATE_MAIL_LEGS.id(), 1, 2);
		currentNpcDrops.addItemDrop(ItemId.TITAN_STEEL_BATTLE_AXE.id(), 1, 1);
		currentNpcDrops.addItemDrop(ItemId.ADAMANTITE_ORE.id(), 2, 2);
		currentNpcDrops.addItemDrop(ItemId.BASS.id(), 2, 2);
