...
public final class Constants {
	...
	public static final Map<Spells, Integer> spellMap = new HashMap<Spells, Integer>() {{
		...
		put(Spells.WATER_STRIKE, 1);
		put(Spells.EARTH_STRIKE, 2);
		put(Spells.FIRE_STRIKE, 3);
		put(Spells.THUNDER_BALL, 4);
		put(Spells.ICICLE_SHOT, 5);
		put(Spells.ACID_DROP, 6);
		put(Spells.BRANCH_SPORE, 7);
		put(Spells.LUMBRIDGE_TELEPORT, 8);
		put(Spells.WEAK_HEAL, 9);
		put(Spells.VARROCK_TELEPORT, 10);
		put(Spells.FALADOR_TELEPORT, 11);
		put(Spells.CAMELOT_TELEPORT, 12);
		put(Spells.ARDOUGNE_TELEPORT, 13);
		put(Spells.WATCHTOWER_TELEPORT, 14);
		put(Spells.WIND_BOLT, 15);
		put(Spells.WATER_BOLT, 16);
		put(Spells.EARTH_BOLT, 17);
		put(Spells.FIRE_BOLT, 18);
		put(Spells.THUNDER_SPLASH, 19);
		put(Spells.ICE_BURST, 20);
		put(Spells.ACID_FROG, 21);
		put(Spells.WOOD_DRILL, 22);
		put(Spells.ALCHEMY, 23);
		put(Spells.TELEKINETIC_GRAB, 24);
		put(Spells.WIND_BLAST, 26);
		put(Spells.WATER_BLAST, 27);
		put(Spells.EARTH_BLAST, 28);
		put(Spells.FIRE_BLAST, 29);
		put(Spells.THUNDER_STRIKE, 30);
		put(Spells.ICE_CRYSTAL, 31);
		put(Spells.ACID_GUSH, 32);
		put(Spells.BATTERING_RAM, 33);
		put(Spells.IBAN_BLAST, 34);
		put(Spells.STRONG_HEAL, 35);
		put(Spells.WIND_WAVE, 36);
		put(Spells.WATER_WAVE, 37);
		put(Spells.EARTH_WAVE, 38);
		put(Spells.FIRE_WAVE, 39);
		put(Spells.CLAWS_OF_GUTHIX, 40);
		put(Spells.SARADOMIN_STRIKE, 41);
		put(Spells.FLAMES_OF_ZAMORAK, 42);
		put(Spells.ZAMORAKS_APOCOLYPSE, 43);
		put(Spells.SARADOMIN_SOUL_SLASH, 44);
		put(Spells.CLAW_OF_GUTHIX, 45);
	}};
