...
public final class MonsterSlayerDialoguePlan {
	...
	public static List<Step> promotion(int tier) {
		switch (tier) {
		case 0: return steps(n("Excellent work!"), n("You've done a fine job culling those monsters."), p("There seem to be just as many as before."), n("Imagine how many there would be without you."), n("You've earned a promotion."), n("You are an Initiate now."), n("Hold still for your rank sticker."), p("A sticker? What happened to the stamp?"), n("Stamps were too impermanent."), p("And stickers are better?"), n("Much better."), n("Wear it with pride."), n("You've earned Fledgling Slayer Points."), n("My associate can trade them for supplies."));
