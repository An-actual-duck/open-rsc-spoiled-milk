...
public final class MonsterSlayerDialoguePlan {
	...
	public static List<Step> promotion(int tier) {
		switch (tier) {
		case 0: return steps(n("Excellent work!"), n("You've done a fine job culling those monsters."), p("There seem to be just as many as before."), n("Imagine how many there would be without you."), n("You've earned a promotion."), n("You are an Adept now."), n("Hold still for your rank sticker."), p("A sticker? What happened to the stamp?"), n("Stamps were too impermanent."), p("And stickers are better?"), n("Much better."), n("Wear it with pride."), n("You've earned Fledgling Slayer Points."), n("My associate can trade them for supplies."));
		case 1: return steps(n("You did what you said you would. That's worth more than loud talk."), n("You're a Veteran now. Wear this button somewhere it won't fall in the drink."), n("The trader beside me deals in Adept Slayer Points. He's cleared to serve Veterans."));
