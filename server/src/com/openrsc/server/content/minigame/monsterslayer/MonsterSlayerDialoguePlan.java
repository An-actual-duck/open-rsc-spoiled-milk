...
public final class MonsterSlayerDialoguePlan {
	...
	public static List<Step> promotion(int tier) {
		...
		case 2: return steps(n("Hah! You did it! Every last task!"), n("You've earned Elite rank."), n("Take this badge."), n("But listen."), n("The fun is over now."), n("Elite work begins inside the true guilds."), n("Not everyone comes back from that work."), n("My associate will trade Veteran Slayer Points with an Elite."));
