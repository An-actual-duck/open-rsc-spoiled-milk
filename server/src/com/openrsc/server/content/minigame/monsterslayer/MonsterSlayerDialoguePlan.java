...
public final class MonsterSlayerDialoguePlan {
	...
	public static List<Step> promotion(int tier) {
		switch (tier) {
		case 0: return steps(n("Excellent work! You've done a fine job culling those monsters."), p("There seem to be just as many as before."), n("Imagine how many there would be if you hadn't helped."), n("For your efforts, I promote you to Initiate. Hold still while I apply your official rank sticker."), p("A sticker? What happened to the stamp?"), n("Stamps have been retired. Far too impermanent."), p("And stickers are better?"), n("Infinitely. You may proudly display it wherever you choose."), n("You've been earning Fledgling Slayer Points while you worked."), n("My associate nearby can trade them for useful supplies."));
		case 1: return steps(n("You did what you said you would. That's worth more than loud talk."), n("You're a Veteran now. Wear this button somewhere it won't fall in the drink."), n("The trader beside me deals in Initiate Slayer Points. He's cleared to serve Veterans."));
