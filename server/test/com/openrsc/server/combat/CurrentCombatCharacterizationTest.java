...
public final class CurrentCombatCharacterizationTest {
	...
	public static void main(final String[] arguments) throws Exception {
		...
		try (CurrentCombatHarness harness = new CurrentCombatHarness(
			...
			run(harness, "dot_target_relog_removal_and_recovery_lifecycle_is_bounded",
				CurrentCombatDotLifecycleCharacterization
					::poisonTargetLifecycleBatch);
			...
			run(harness, "earth_dragon_slow_preserves_rng_damage_and_refresh_policy",
				CurrentCombatEarthDragonSlowProcCharacterization
					::earthDragonSlowPolicies);
			...
			run(harness, "king_black_dragon_set_uses_middle_dragon_breath_profile",
				CurrentCombatOwnedDamageCharacterization::kingBlackDragonSetProfile);
			...
			run(harness, "tutorial_and_logged_out_player_death_compatibility_is_preserved",
				CurrentCombatDeathLifecycleCharacterization::playerTutorialAndLoggedOutCompatibility);
