...
public final class HorvikTheArmourer extends AbstractShop {
	...
	private final Shop shop = new Shop(false, 30000, 100, 60, 2,
		...
		new Item(ItemId.TIN_PLATE_MAIL_BODY.id(), 3),
		new Item(ItemId.COPPER_PLATE_MAIL_BODY.id(), 3),
		new Item(ItemId.BRONZE_PLATE_MAIL_BODY.id(), 3),
		new Item(ItemId.IRON_PLATE_MAIL_BODY.id(), 2),
		new Item(ItemId.STEEL_PLATE_MAIL_BODY.id(), 2),
