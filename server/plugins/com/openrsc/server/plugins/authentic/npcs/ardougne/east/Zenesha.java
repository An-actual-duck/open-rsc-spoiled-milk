...
public class Zenesha extends AbstractShop {
	...
	private final Shop shop = new Shop(false, 30000, 100, 60, 2,
		new Item(ItemId.BRONZE_PLATE_MAIL_TOP.id(), 3),
		new Item(ItemId.IRON_PLATE_MAIL_TOP.id(), 2),
		new Item(ItemId.STEEL_PLATE_MAIL_TOP.id(), 2),
		new Item(ItemId.MITHRIL_PLATE_MAIL_TOP.id(), 1));
