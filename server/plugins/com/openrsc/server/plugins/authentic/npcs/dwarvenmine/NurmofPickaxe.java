...
public final class NurmofPickaxe extends AbstractShop {
	...
	private final Shop shop = new Shop(false, 25000, 100, 60, 2, new Item(ItemId.TIN_PICKAXE.id(),
		6), new Item(ItemId.COPPER_PICKAXE.id(), 6), new Item(ItemId.BRONZE_PICKAXE.id(), 6), new Item(ItemId.IRON_PICKAXE.id(), 5), new Item(ItemId.STEEL_PICKAXE.id(), 4),
		new Item(ItemId.MITHRIL_PICKAXE.id(), 3), new Item(ItemId.ADAMANTITE_PICKAXE.id(), 2), new Item(ItemId.TITAN_STEEL_PICKAXE.id(), 2),
		new Item(ItemId.ORICHALCUM_PICKAXE.id(), 1), new Item(ItemId.RUNE_PICKAXE.id(), 1));
