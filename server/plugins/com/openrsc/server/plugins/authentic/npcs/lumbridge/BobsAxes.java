...
public final class BobsAxes extends AbstractShop {
	...
	private final Shop shop = new Shop(false, 15000, 100, 60, 2,
		new Item(ItemId.TIN_PICKAXE.id(), 5), new Item(ItemId.COPPER_PICKAXE.id(), 5), new Item(ItemId.BRONZE_PICKAXE.id(), 5),
		new Item(ItemId.TIN_AXE.id(), 10), new Item(ItemId.COPPER_AXE.id(), 10), new Item(ItemId.BRONZE_AXE.id(), 10),
		new Item(ItemId.IRON_AXE.id(), 5), new Item(ItemId.STEEL_AXE.id(), 3), new Item(ItemId.MITHRIL_AXE.id(), 1),
		new Item(ItemId.TIN_BATTLE_AXE.id(), 5), new Item(ItemId.COPPER_BATTLE_AXE.id(), 5), new Item(ItemId.BRONZE_BATTLE_AXE.id(), 5),
