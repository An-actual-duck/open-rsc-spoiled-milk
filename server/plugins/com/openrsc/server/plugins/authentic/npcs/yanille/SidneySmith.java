...
public class SidneySmith implements TalkNpcTrigger, UseNpcTrigger {
			...
			case Sidney.CERTIFICATE_TO_GOODS:
				if (!player.getCarriedItems().hasCatalogID(DRAGON_BONES_CERT, Optional.of(false)) &&
					...
					npcsay(player, n, "Sorry, but you don't have any certificates that I can change.",
						...
						"and Limpwurt Root Certificates.");
				} else {
	...
	private void goodsMenu(Player player, Npc n) {
	...
	private void certMenu(Player player, Npc n) {
	...
	public boolean blockUseNpc(Player player, Npc npc, Item item) {
		return npc.getID() == SIDNEY_SMITH && inArray(item.getCatalogId(), DRAGON_BONES,
			LIMPWURT_ROOT, DRAGON_BONES_CERT, LIMPWURT_ROOT_CERT);
	}
	...
	public void onUseNpc(Player player, Npc npc, Item item) {
		...
		if (npc.getID() == SIDNEY_SMITH && inArray(item.getCatalogId(), DRAGON_BONES,
			LIMPWURT_ROOT, DRAGON_BONES_CERT, LIMPWURT_ROOT_CERT)) {
