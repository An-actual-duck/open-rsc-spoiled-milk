...
public class Drogo extends AbstractShop {
	...
	private final Shop shop = new Shop(false, 30000, 100, 70, 2, new Item(ItemId.HAMMER.id(),
		4), new Item(ItemId.TIN_PICKAXE.id(), 4), new Item(ItemId.COPPER_PICKAXE.id(), 4), new Item(ItemId.BRONZE_PICKAXE.id(), 4), new Item(ItemId.COPPER_ORE.id(), 0), new Item(ItemId.TIN_ORE.id(), 0),
		new Item(ItemId.IRON_ORE.id(), 0), new Item(ItemId.COAL.id(), 0), new Item(ItemId.TIN_BAR.id(), 0), new Item(ItemId.COPPER_BAR.id(), 0), new Item(ItemId.BRONZE_BAR.id(), 0),
