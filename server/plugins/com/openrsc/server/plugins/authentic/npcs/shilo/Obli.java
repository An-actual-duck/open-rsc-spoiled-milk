...
public class Obli extends AbstractShop {
	...
	private final Shop shop = new Shop(true, 15000, 150, 50, 2,
		...
		new Item(ItemId.IRON_AXE.id(), 5), new Item(ItemId.BOOTS.id(), 10), new Item(ItemId.COOKEDMEAT.id(), 2),
		...
		new Item(ItemId.PAPYRUS.id(), 50), new Item(ItemId.A_LUMP_OF_CHARCOAL.id(), 50),
