...
public class Scavvo extends AbstractShop {
	...
	public Shop getShop(World world) {
		if(scavvosShop == null) {
			scavvosShop = new Shop(false, 300000, 100, 60, 2,
				new Item(ItemId.RUNE_PLATE_MAIL_BODY.id(), 1),
				new Item(ItemId.RUNE_PLATE_MAIL_LEGS.id(), 1),
				new Item(ItemId.RUNE_KITE_SHIELD.id(), 1),
