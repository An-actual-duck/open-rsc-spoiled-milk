...
public class Sleeping implements OpLocTrigger, OpInvTrigger {
	...
	public void onOpLoc(Player owner, final GameObject object, String command) {
		if (!owner.getConfig().FEATURES_SLEEP) {
			return;
		}
	...
	public boolean blockOpLoc(Player player, GameObject obj, String command) {
		return player.getConfig().FEATURES_SLEEP && (command.equals("rest") || command.equals("sleep") || command.equals("lie in"));
	}
	...
	public boolean blockOpInv(Player player, Integer invIndex, Item item, String command) {
		return player.getConfig().FEATURES_SLEEP && item.getCatalogId() == ItemId.SLEEPING_BAG.id();
	}
}
