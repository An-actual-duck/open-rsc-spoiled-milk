...
public final class WaxEarplugs implements OpInvTrigger {
	...
	@Override public void onOpInv(Player player, Integer index, Item item, String command) {
		...
		BansheeCombat.applyEarplugs(player);
		player.message(left == 0 ? "You have used the last of your Wax earplugs."
			: "You have " + left + (left == 1 ? " use" : " uses") + " of Wax earplugs left.");
	}
}
