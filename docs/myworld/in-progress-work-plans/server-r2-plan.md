...
- Ant currently compiles 923 Java files from `server/src` into a fat executable
  `server/core.jar`.
...
with 1,782 native sectors and 33,526 effective placements.
...
- Checked-in Spoiled Milk configuration requires custom client version `10051`.
