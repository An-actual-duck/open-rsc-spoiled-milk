...
| --- | ---: | --- | --- | --- |
| `server/src` | 916 Java files | `compile_core` | `server/core.jar` | Executable fat jar with `com.openrsc.server.Server` as `Main-Class` and every `server/lib/*.jar` merged into it |
