...
public class BankInterface {
	...
	public void sendWithdraw(int i) {
		if (this.selectedBankSlot < 0 || this.selectedBankSlot >= currentItems.size()) return;
		Item item = currentItems.get(this.selectedBankSlot);
		if (item == null) return;
