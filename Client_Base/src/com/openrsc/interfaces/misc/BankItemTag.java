...
enum BankItemTag {
	...
	private static boolean isEnchantableBaseJewelry(String name) {
		return equalsAny(name,
			...
			"dragonstone necklace", "sapphire bangle", "emerald bangle", "ruby bangle",
			"diamond bangle", "dragonstone bangle");
	}
	...
	private static boolean isJewelry(String name) {
		return containsAny(name, "amulet", "necklace", "bracelet", "bangle", "medallion", "symbol", "holy mould", "tiara")
	...
	private static boolean isJewelryMould(String name) {
		return equalsAny(name, "ring mould", "necklace mould", "bangle mould", "holy symbol mould",
