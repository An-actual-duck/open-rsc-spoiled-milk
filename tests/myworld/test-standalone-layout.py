...
def test_myworld_docs_are_consolidated() -> None:
    ...
    expected_by_category = {
        "in-progress-work-plans": [
            ...
            "ante-risk-reward-plan.md",
            "boss-leather-tier-progression-plan.md",
            ...
            "dragon-rune-two-hander-audit.md",
        ...
        "completed-work-plans": [
            ...
            "classic-scape-combat-refactor-audit-2026-08-05.md",
            ...
            "soul-altar-layered-map-gap-investigation.md",
        ],
        "rough-drafts": [
        ...
        "info": [
            "ai-operability-routing-audit-2026-08-13.md",
            "change-history.md",
            "classic-scape-model-to-sprite-tool-audit.md",
