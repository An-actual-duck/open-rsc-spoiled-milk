...
def main() -> None:
    ...
    require_snippet(NPC_BEHAVIOR, "npc.getWorld(), checkedLocation, target.getWorldLocation(),", "NPC behavior exact-layer adjacent-distance check")
    ...
    require_snippet(PVM_MELEE_EVENT, "boolean adjacent = !sameTile && PathValidation.checkAdjacentDistance(", "PVM melee cached adjacent check")
    require_snippet(PVM_MELEE_EVENT, "attackerMob, targetMob, true, false)", "PVM melee layer-aware adjacent operands")
