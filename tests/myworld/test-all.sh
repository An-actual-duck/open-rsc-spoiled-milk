...
export SPOILED_MILK_LAYERED_PACKAGE="$ROOT_DIR/server/world-builder/packages/f07264aca7b93fc3bc27991daf9187c468611a7d636c98b10cf695814a2add7f/package"
...
python3 ./tests/myworld/test-equipment-animation-id-contract.py
python3 ./tests/myworld/test-exalted-rune-gathering-tools.py
python3 ./tests/myworld/test-exalted-rune-poisoned-weapons.py
...
python3 ./tests/myworld/test-foundry-dragon-summon.py
