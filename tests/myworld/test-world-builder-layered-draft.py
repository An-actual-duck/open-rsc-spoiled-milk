...
public final class WorldBuilderLayeredDraftHarness {
    ...
    public static void main(String[] args) throws Exception {
        ...
        require(before.levels.size() == 6, "initial levels");
        require(before.terrainSectorCount == 1782, "initial terrain count");
        ...
        require(created.terrainSectorCount == 1791, "created terrain count");
        require(created.placementSetCount == 7, "created placement count");
        ...
        require(draft.terrainSectorCount == 1792, "grown terrain count");
