...
for entry, npc in zip(manifest, defs):
    ...
    assert npc['attackable'] == (1 if npc['id'] in (863, 864, 865, 866, 867, 868, 869) else 0)
    ...
    assert (npc['hits'], npc['combatlvl']) == {863: (30, 20), 864: (45, 35), 865: (60, 50), 866: (75, 60), 867: (90, 75), 868: (150, 85), 869: (200, 105)}.get(npc['id'], (1, 1))
