...
def validate_definitions_and_scope() -> None:
    ...
    require(max(entries) == 3310, "custom definitions must include the current contiguous item range")
    ...
    require("public static final int maxCustom = 3311;" in legacy_constants,
