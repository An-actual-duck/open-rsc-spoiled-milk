...
def main() -> None:
    ...
    require_exact(items_by_id, 314, "magicOffense", 2, "Sapphire Bangel of magic profile")
    require_exact(items_by_id, 315, "meleeDefense", 1, "Emerald Bangel of protection profile")
    require_exact(items_by_id, 316, "meleeOffense", 2, "Ruby Bangel of strength profile")
    require_exact(items_by_id, 317, "meleeOffense", 1, "Diamond Bangel of power profile")
    require_exact(items_by_id, 317, "magicOffense", 2, "Diamond Bangel of power profile")
    require_exact(items_by_id, 317, "meleeDefense", 1, "Diamond Bangel of power profile")
