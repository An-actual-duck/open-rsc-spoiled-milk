...
public final class ExtensionRegistryFixture {
 ...
 public static void main(String[] a)throws Exception{
  ...
  r.discover(Arrays.asList(new E("provider",false,false,ExtensionHealth.HEALTHY,ExtensionReloadPolicy.HOT_RELOAD_SUPPORTED,caps("world@1.4.0"),Collections.<ExtensionCapability>emptySet()),new E("consumer",false,false,ExtensionHealth.HEALTHY,ExtensionReloadPolicy.HOT_RELOAD_SUPPORTED,Collections.<ExtensionCapability>emptySet(),caps("world@1.2.0"))));r.resolve();r.reset();
