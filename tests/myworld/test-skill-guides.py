...
def main() -> None:
    ...
    require(guide, 'Blessing Prayer XP rises by 1% per devotion', "blessing XP guide")
    ...
    require(guide, "Destruction grants 5x the item's production Prayer XP", "destruction XP guide")
