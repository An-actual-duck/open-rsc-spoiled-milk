...
def main() -> None:
    ...
    require(guide, 'new SkillMenuItem(2237, "70", "Blood staff blessed by Zamorak - requires Worship and Magic")', "blessed blood staff prayer guide")
    ...
    require(guide, 'new SkillMenuItem(3137, "100", "Wool hats can be blessed")', "blessed wool hat prayer guide")
    require(guide, 'new SkillMenuItem(3138, "400", "Wool robe tops can be blessed")', "blessed wool robe top prayer guide")
    ...
    require(guide, "Bless items only at your current god's altar", "blessing altar alignment guide")
    require(guide, 'Symbols require 50 devotion and are free to bless', "symbol blessing devotion guide")
    require(guide, 'Blessed items grow stronger with devotion', "blessed item scaling prayer guide")
    require(guide, 'Blessing Worship XP rises by 1% per devotion', "blessing XP guide")
    require(guide, 'Equipment requires 100 devotion per resource', "blessing resource devotion guide")
    require(guide, 'Blessing equipment costs 0.5 devotion per resource', "blessing cost guide")
    require(guide, 'You may complete 10 blessings per hour', "hourly blessing limit guide")
    require(guide, "Destroy opposing god's blessed items at your altar", "opposing blessed item destruction guide")
    require(guide, 'Destruction transfers 1 devotion per resource or staff tier', "opposing blessed item devotion transfer guide")
    require(guide, 'Symbols transfer 0.2 devotion when destroyed', "symbol destruction guide")
    require(guide, "Destruction grants 5x the item's production Worship XP", "destruction XP guide")
    require(guide, 'God artifacts cannot be destroyed', "artifact exclusion guide")
    require(guide, '1 resource: daggers, short swords, maces, helms, wool hats', "one-resource devotion unlock guide")
    require(guide, '2 resources: longs, scims, spears, gloves, boots', "two-resource devotion unlock guide")
    require(guide, '3 resources: 2-handers, battleaxes, shields, legs, scythes', "three-resource devotion unlock guide")
    require(guide, '4 resources: bodies and robe tops', "four-resource devotion unlock guide")
    require(guide, 'Basic staves require 100; blood staves require 1000', "blood staff devotion unlock guide")
    require(guide, 'mc.getSkillGuideChosen().equals("Worship") && tab.equals("Devotion")', "devotion tab should render as info text")
    ...
    require(guide, 'Insight boosts Magic, Enchanting, Summoning, Cooking, Worship', "insight effect guide")
    ...
    require(guide, 'new SkillMenuItem(2328, "1", "Gnome Stronghold Course - Stronghold Chest per lap")', "gnome agility chest guide")
    require(guide, 'new SkillMenuItem(2329, "35", "Barbarian Outpost Course - Outpost Chest per lap")', "barbarian agility chest guide")
    require(guide, 'new SkillMenuItem(2330, "52", "Wilderness Course - Wilderness Chest per lap")', "wilderness agility chest guide")
