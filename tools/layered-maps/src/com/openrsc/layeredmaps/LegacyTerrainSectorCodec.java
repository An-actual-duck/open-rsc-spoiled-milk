...
/** Checked codec for legacy {@code h{plane}x{archiveX}y{archiveY}} entry names. */
public final class LegacyTerrainSectorCodec {
	...
	private LegacyTerrainSectorCodec() {
	}
	...
	public static WorldMapSectorId fromLegacySector(
		...
		return new WorldMapSectorId(
			WorldSpaceId.GLOBAL,
			LegacyPackedCoordinateCodec.levelForLegacyPlane(legacyPlane),
	...
	public static String encode(WorldMapSectorId sector) {
		...
		int plane = LegacyPackedCoordinateCodec.legacyPlaneForLevel(sector.getLevel());
